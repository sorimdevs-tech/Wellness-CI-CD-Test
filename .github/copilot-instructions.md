...
python main.py  # runs on https://wellnessdev.onrender.com
```
...
Backend: Use FastAPI's built-in Swagger UI at https://wellnessdev.onrender.com/docs to test endpoints
